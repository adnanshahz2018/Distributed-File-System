 ...
 * all data coming from the Root is saved in file. file name is specified by the Root. 
 * surely ending with 'A'
*/
...
public static int numclient = 0 ;
	...
	{		
		try
    	{
	    	...
	    	{ 		
	    		...
	    		client=ss.accept();										
		    	System.out.println(" ServerA Accepted connection request# " + ++numclient);	
		    		
		    	// getting the choice from the Root 
		    	String choice = getname();
				
		    	if(choice.equals("11RFD"))			// Retrive File For Download
		    	{
		    		sendfile();
		    	}
		    	else
	...
	public static String getname()
	{
    	...
    	System.out.println(" name in A = " + name);
    	return name ;
	}
	...
	public static void savefile(String name)
	{
    	...
    	String filename = name + ".A" + ".txt";
    	
    	System.out.println("Saving file in A \n");
    	try
		{			
    		// Capturing & Reading Client's Data 
    		client=ss.accept();
